namespace Narumikazuchi.Serialization
{
    ...
    public abstract partial class SerializerBase<T>
    {
        ...
        public void ApplyStrategy(Type forType,
                                  ISerializationStrategy<T> strategy)
        {
    ...
    partial class SerializerBase<T>
    {
        ...
        /// </summary>
        protected SerializerBase(IReadOnlyDictionary<Type, ISerializationStrategy<T>> strategies)
        {
            ExceptionHelpers.ThrowIfNull(strategies);
        ...
        protected static Object CreateObject(SerializationInfo info)
        {
#nullable disable
